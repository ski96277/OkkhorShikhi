...
class Small_Letter_Adapter(var small_Litter_List: ArrayList<String>) :
    ...
    class ViewHolderClass(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun setValue(small_Litter_List: String) {
            itemView.item_text_small_letter.text = small_Litter_List
        }
    }
}